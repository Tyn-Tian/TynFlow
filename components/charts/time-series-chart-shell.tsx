...
export interface TimeSeriesChartInnerProps {
  ...
  /** When true, y-axis min is based on the data minimum rather than 0. */
  yDomainFromData?: boolean;
}
...
const TimeSeriesChartCore = memo(function TimeSeriesChartCore({
  ...
  const yScale = useMemo(() => {
    ...
    const domain = resolveTimeSeriesYDomain(data, dataKeys, yScaleDomainMax, yDomainFromData);
  ...
  }, [innerHeight, data, lines, yScaleDomainMax, yDomainFromData]);
